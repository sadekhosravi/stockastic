                    ...
                    <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                        ...
                        <div class="carousel-item active">  
                            <div class="carousel-container">
                                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Stockastic</span></h2>
                    ...
                    <section class="features">
                        <div class="container">
                            ...
                            <div class="section-title">
                                <h2>Features</h2>
                                <p>our app is capale of tracking and forcasting diffrent stocks, we visualize track and prediction of your data in any way you Want.</p>
                            </div>
                            ...
                            <div class="row" data-aos="fade-up">
                                ...
                                <div class="col-md-7 pt-4">
                                    <h3>Coverage Of Every Stock You Want</h3>
                                    <p class="fst-italic">
                            ...
                            <div class="row" data-aos="fade-up">
                                ...
                                <div class="col-md-7 pt-5 order-2 order-md-1">
                                    <h3>Various Types Of Plots For Analyse</h3>
                                    <p class="fst-italic">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore
                                        magna aliqua.
                                    </p>
